...
/** Java `MainWindowMenuHandler` *ActionPerformed methods, in source order. */
export const JAVA_MENU_ACTIONS = [
  "project.new",
  "project.team-new",
  "project.open",
  ...
  "project.compile-single",
  "project.edit",
  "project.files",
  "project.access-root",
  "project.access-dict",
  "project.access-glossary",
  "project.access-source",
  "project.access-target",
  "project.access-tm",
  "project.access-export-tm",
  "project.access-current-source",
  "project.access-current-target",
  "project.access-writable-glossary",
  "project.exit",
  "project.restart",
  "edit.undo",
  "edit.redo",
  "edit.overwrite-translation",
  "edit.insert-translation",
  "edit.overwrite-mt",
  "edit.overwrite-source",
  "edit.insert-source",
  "edit.select-source",
  ...
  "edit.multiple-alt",
  "edit.register-untranslated",
  "edit.register-empty",
  "edit.register-identical",
  "options.prefs",
  "edit.case-cycle",
  "edit.case-sentence",
  "edit.case-title",
  ...
  "goto.match-source",
  "view.mark-translated",
  "view.mark-untranslated",
  "view.mark-paragraph",
  "view.display-source",
  "view.mark-nonunique",
  "view.mark-noted",
  "view.mark-nbsp",
  "view.mark-whitespace",
  "view.mark-bidi",
  "view.mark-alt",
  "view.mark-auto",
  "view.mark-glossary",
  ...
  "edit.tag-painter",
  "edit.tag-next",
  "tools.stats-standard",
  "tools.stats-matches",
  "tools.stats-files",
  "options.completer-auto",
  "options.history-completion",
  "options.history-prediction",
  "options.mt-auto",
  "options.glossary-fuzzy",
  "options.dict-fuzzy",
  "options.filters",
...
export const SCRIPT_SLOT_ACTIONS = Array.from({ length: 12 }, (_, i) => `tools.script-${i + 1}`);
...
export async function dispatchMenuAction(action: string, _payload?: unknown): Promise<void> {
  const a = useApp.getState();
  const e = a.entries[a.index];
  if (action.startsWith("tools.script-")) {
    const n = Number(action.slice("tools.script-".length));
    if (n >= 1 && n <= 12) await a.runScriptSlot(n);
    return;
  }
  switch (action) {
    case "project.new":
    ...
    case "edit.multiple-default":
      await a.commit({ default_translation: true });
      break;
    case "edit.multiple-alt":
      await a.commit({ default_translation: false });
      break;
    ...
    case "goto.unique":
      ...
      break;
    case "goto.note-next":
      await a.jump("note", undefined, 1);
      break;
    case "goto.note-prev":
      await a.jump("note", undefined, -1);
      break;
    case "goto.auto-next":
      await a.jump("auto", undefined, 1);
      break;
    case "goto.auto-prev":
      await a.jump("auto", undefined, -1);
      break;
    case "goto.enforce-next":
      await a.jump("enforce", undefined, 1);
      break;
    case "goto.enforce-prev":
      await a.jump("enforce", undefined, -1);
      break;
    case "goto.match-source":
      await a.gotoMatchSource();
      break;
    ...
    case "options.glossary-fuzzy":
      await a.patchPrefs({ glossary_not_exact_match: !a.prefs?.glossary_not_exact_match });
      break;
    case "options.dict-fuzzy":
      await a.patchPrefs({ dictionary_fuzzy_matching: !a.prefs?.dictionary_fuzzy_matching });
      break;
    ...
    case "help.tip":
      ...
      break;
    case "help.changes":
      a.openWindow("changes");
      break;
    case "help.manual":
      await window.omegat?.openManual?.();
      break;
    case "help.updates":
      if (a.prefs?.version_check_enabled !== false) {
