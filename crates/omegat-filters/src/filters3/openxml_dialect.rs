...
impl OpenXmlDialect {
    pub fn new(options: &HashMap<String, String>) -> Self {
        ...
        inner.define_paragraph_tags(&[
            "w:p", "w:tab", "dc:title", "dc:subject", "dc:creator", "si", "comment",
            "definedName", "a:p", "c:v", "Text",
        ]);
        ...
        inner.define_intact_tags(&[
            "authors", "rPh", "definedNames", "p:attrName", "a:tableStyleId", "c:f",
            "c:formatCode", "wp:align", "wp:posOffset", "wp14:pctWidth", "wp14:pctHeight",
            "w:fldChar", "cp:lastModifiedBy", "cp:revision", "cp:lastPrinted",
            "dcterms:created", "dcterms:modified", "cp:version", "xdr:col", "xdr:row",
            "xdr:colOff", "xdr:rowOff", "DocumentProperties", "DocumentSettings", "Colors",
            "FaceNames", "StyleSheets", "DocumentSheet", "Masters", "Misc", "TextBlock",
            "Geom", "Para", "Char", "Connection", "XForm", "Line", "Fill", "Event",
            "PageSheet", "PageProps", "PageLayout", "PrintProps", "PageHeight", "PageWidth",
            "Image", "PinY", "Width", "Height", "XForm1D", "EndX", "LayerMem", "TextXForm",
            "Control", "ForeignData", "Foreign", "Menu", "Act", "User", "Help", "Copyright",
            "VBProjectData", "FooterMargin", "HeaderMargin", "HeaderFooter", "Window",
            "Windows", "EventList", "Scratch", "Protection", "Layout", "Icon", "vx:Event",
            "v14:Geom", "vx:Fill", "PreviewPicture", "vx:Char", "vx:Color", "vx:Line",
            "FillForegnd", "ShdwBkgnd", "TextBkgnd", "vx:TextBkgnd",
        ]);
