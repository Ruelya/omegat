...
static THAI_LEX: Lazy<HashSet<&'static str>> = Lazy::new(|| {
    const WORDS: &[&str] = &[
        "ภาษา", "ไทย", "เป็น", "ราชการ", "ของ", "ประเทศ", "และ", "ใน", "ที่", "การ", "มี",
        "ได้", "ไม่", "จะ", "กับ", "จาก", "โดย", "หรือ", "นี้", "นั้น", "คน", "วัน", "ปี",
        "บ้าน", "น้ำ", "กิน", "ไป", "มา", "อยู่", "ทำ", "พูด", "เขียน", "อ่าน", "เรียน",
        "โรงเรียน", "มหาวิทยาลัย", "กรุงเทพ", "เชียงใหม่", "ภูเก็ต", "อาหาร", "วัฒนธรรม",
        "ประวัติศาสตร์", "วิทยาศาสตร์", "เทคโนโลยี", "เศรษฐกิจ", "การเมือง", "สังคม",
        "ธรรมชาติ", "สิ่งแวดล้อม", "การศึกษา", "สุขภาพ", "ครอบครัว", "เพื่อน", "เด็ก",
        "ผู้ใหญ่", "ผู้หญิง", "ผู้ชาย", "เวลา", "สถานที่", "ความหมาย", "คำถาม", "คำตอบ",
    ];
